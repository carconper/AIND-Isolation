...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=custom_score), "AB_MPP"),
    ...
    cpu_agents = [
        ...
        Agent(MinimaxPlayer(score_fn=custom_score_2), "MM_MPN"),
        #Agent(MinimaxPlayer(score_fn=center_score), "MM_Center"),
        #Agent(MinimaxPlayer(score_fn=improved_score), "MM_Improved"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_2), "AB_MPN"),
