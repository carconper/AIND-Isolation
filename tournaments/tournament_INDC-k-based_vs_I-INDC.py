...
from game_agent import (MinimaxPlayer, AlphaBetaPlayer, custom_score,
                        ...
                        custom_score_8, custom_score_9, custom_score_11,
                        custom_score_12, custom_score_13, custom_score_14)
...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=custom_score_11), "AB_INDC_k-medium"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_13), "AB_INDC_k-high"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_14), "AB_INDC_k-low")
    ]

    # Define a collection of agents to compete against the test agents
    cpu_agents = [
        #Agent(RandomPlayer(), "Random"),
        #Agent(MinimaxPlayer(score_fn=custom_score_6), "MM_DON"),
        #Agent(MinimaxPlayer(score_fn=center_score), "MM_Center"),
        #Agent(MinimaxPlayer(score_fn=improved_score), "MM_Improved"),
        #Agent(AlphaBetaPlayer(score_fn=custom_score_6), "AB_DON"),
