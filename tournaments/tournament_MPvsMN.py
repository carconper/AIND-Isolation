...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=custom_score_4), "AB_MP"),
    ...
    cpu_agents = [
        ...
        Agent(MinimaxPlayer(score_fn=custom_score_3), "MM_MN"),
        #Agent(MinimaxPlayer(score_fn=center_score), "MM_Center"),
        #Agent(MinimaxPlayer(score_fn=improved_score), "MM_Improved"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_3), "AB_MN"),
